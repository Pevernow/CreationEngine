...
public:
    ...
    static connection::shared_ptr create(
    ...
    // changing udp_remote_endpoint at every packet. Because we allow connection
    // change ip or port. we using conv to indicate a connection.
    void input(
