...
public:
    ...
    // this func should be multithread safe if running UdpPacketHandler in work
    // thread pool.  can implement by io_service.dispatch
    void call_event_callback_func(
        kcp_conv_t conv, eEventType event_type,
